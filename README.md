# AFAS-YOLOv8
 <p align="justify"> 
This is the official repository of "Addressing false alarm situations in subpixel fire detection: a YOLOv8-based approach". In this repository, you can find all the annotations discussed in the article, in addition to the images that have been proposed by the team.
</p>
