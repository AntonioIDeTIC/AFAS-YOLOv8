# AFAS-YOLOv8
<p align="justify"> 
Welcome to the official repository for "Addressing False Alarms from High-Voltage Structures in Subpixel Fire Detection". This repository contains all the necessary resources to replicate the experiments presented in our study.
</p>
...
* FLIR ADAS Dataset: Please refer to the <a href="https://oem.flir.com/solutions/automotive/adas-dataset-form/" target="_blank">FLIR ADAS Terms of Use</a> for conditions on using FLIR ADAS data.
...
> Antonio Galván-Hernández, Víctor Araña-Pulido, Francisco Cabrera-Almeida, Pedro Quintana-Morales (2025).  
